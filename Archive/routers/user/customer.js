...
router.route('/guestuser').get(getGuestCustomer);
router.route('/guestuser/:id').get(singlegetGuestCustomer);
router.route('/registeruser').get(getRegisteruser);
router.route('/registeruser/:id').get(singlegetRegisteruser);
