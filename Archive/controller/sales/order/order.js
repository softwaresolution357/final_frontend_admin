...
exports.getSingleOrder = async (req, res, next) => {
  ...
  res.status(202).json({
    ...
    sigledata: {
      ...
      customer:single_order_data.customerid,
      ...
      currentdescription:single_order_data.orderstatusdescription.currentstatus,
      ...
      billingaddress: single_order_data.customerid.billingaddress,
      billingpincode: single_order_data.customerid.billingpincode,
      billingcity: single_order_data.customerid.billingcity,
      sbillingstate: single_order_data.customerid.billingstate,
      sbillingcountry: single_order_data.customerid.billingcountry,
      shippingaddress: single_order_data.customerid.shippingaddress,
      shippinglandmark: single_order_data.customerid.shippinglandmark,
      shippingpincode: single_order_data.customerid.shippingpincode,
      shippingcity: single_order_data.customerid.shippingcity,
      shippingstate: single_order_data.customerid.shippingstate,
      shippingcountry: single_order_data.customerid.shippingcountry,
