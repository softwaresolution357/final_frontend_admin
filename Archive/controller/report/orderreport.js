...
exports.OrderReport= async(req,res,next)=>{
 ...
 const differencedate = moment.utc(req.query.end.split(" ")[0]).diff(req.query.start.split(" ")[0],'days');
    ...
    twentyfourdate +=twentyfourmomnet;
     ...
     fainaldata.push(ninteendate,twentydate,twentyonedate,twentytwodate,twentythreedate,twentyfourdate,onedate,twodate,threedate,fourdate,fivedate,sixdate,sevendate,eightdate,ninedate,tendatet,
     elevendate,twelvedate,thirteendate,fourteendate,fifteendate,sixteendate,seventeendate,eighteendate)
    ...
    twentyfourdate +=twentyfourmomnet;
           ...
           fainaldata.push(twentyfourdate,twentythreedate,twentytwodate,twentyonedate,twentydate,ninteendate,onedate,twodate,threedate,fourdate,fivedate,sixdate,sevendate,eightdate,ninedate,tendatet,
            )
